...
DROP TRIGGER IF EXISTS log_shopify_installation_changes ON shopify_installations;
DROP FUNCTION IF EXISTS log_installation_change();
...
CREATE FUNCTION log_installation_change()
RETURNS TRIGGER AS $$
DECLARE
