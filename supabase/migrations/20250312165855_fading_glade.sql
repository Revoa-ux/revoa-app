/*
  # Fix OAuth Session Validation

  1. Changes
    - Drop existing OAuth sessions table and related objects
    - Create new OAuth sessions table with proper constraints
    - Add RLS policies with correct permissions
    - Add cleanup trigger for expired sessions

  2. Security
    - Enable RLS
    - Add policy for unauthenticated access during OAuth
