...
BEGIN
  ...
  -- If email is from revoa.app domain, create admin user
...
COMMENT ON FUNCTION handle_new_user IS 'Automatically confirms email, creates profile, and handles admin users';