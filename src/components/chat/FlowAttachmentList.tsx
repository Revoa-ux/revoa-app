      ...
      <div className="grid grid-cols-2 gap-3">
        {attachments.map((attachment) => {
          ...
          return (
            <div
              key={attachment.id}
              className="group relative border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden bg-white dark:bg-gray-800 hover:shadow-md transition-shadow"
            >
              {/* Thumbnail or Icon */}
