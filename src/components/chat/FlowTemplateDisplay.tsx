...
export function FlowTemplateDisplay({
  ...
  return (
    <div className="mt-4">
      <div className="bg-gray-50 dark:bg-dark/50 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
        {/* Subject Line */}
        <div className="mb-3">
          ...
          <>
            {!isPopulated ? (
              <button
                ...
                disabled={isLoading}
                className="inline-flex items-center justify-center gap-2 px-3 py-1.5 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-dark hover:bg-gray-50 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isLoading ? (
                  <>
              ...
              <button
                onClick={handleCopy}
                disabled={isCopied}
                className="inline-flex items-center justify-center gap-2 px-3 py-1.5 text-sm font-medium text-white bg-gray-800 dark:bg-gray-700 hover:bg-dark dark:hover:bg-gray-600 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isCopied ? (
                  <>
