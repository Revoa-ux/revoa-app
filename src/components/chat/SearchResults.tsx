    ...
    <div className="space-y-2">
      {results.map((message) => (
        <button
          ...
          className="w-full p-4 text-left bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-700 rounded-lg transition-colors"
        >
