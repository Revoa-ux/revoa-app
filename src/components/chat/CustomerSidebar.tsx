...
export const CustomerSidebar: React.FC<CustomerSidebarProps> = ({
  ...
  return (
    <>
      <div className="w-72 lg:w-80 flex-shrink-0 border-l border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 flex flex-col overflow-hidden transition-all duration-300">
