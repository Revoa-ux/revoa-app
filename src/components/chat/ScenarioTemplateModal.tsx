          ...
          <div className="border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
            ...
            <div className="px-6 py-4 flex items-center justify-between">
              <button
                ...
                className="h-10 px-5 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-colors flex items-center gap-2"
              >
              ...
              <div className="flex items-center gap-4">
                ...
                {isAssignedToOrder ? (
                  <button
                    ...
                    className="group h-10 px-5 text-sm font-medium text-white bg-gray-900 dark:bg-gray-700 hover:bg-gray-800 dark:hover:bg-gray-600 hover:shadow-md rounded-lg transition-all flex items-center gap-2 shadow-sm"
                  >
                    {copied ? (
                      <>
                  ...
                  <button
                    ...
                    disabled={isLoading}
                    className="group h-10 px-5 text-sm font-medium text-white bg-gray-900 dark:bg-gray-700 hover:bg-gray-800 dark:hover:bg-gray-600 hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed rounded-lg transition-all flex items-center gap-2 shadow-sm"
                  >
                    {isLoading ? (
                      <>
