    ...
    <div className="max-w-[540px] mx-auto">
      <div className="bg-white dark:bg-dark rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8">
        <div className="text-center mb-8">
          ...
          {hasExistingData && (
            <div className="mt-3 inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-gray-100 dark:bg-dark border border-gray-300 dark:border-gray-600">
        ...
        <div className="space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-900 dark:focus:ring-white focus:border-gray-900 dark:focus:border-white text-gray-900 dark:text-white bg-white dark:bg-dark placeholder:text-gray-400 dark:placeholder:text-gray-500"
              disabled={isLoading}
            />
          </div>
          ...
          <div>
            ...
            <div className="relative" ref={storeTypeDropdownRef}>
              ...
              {showStoreTypeDropdown && (
                <div className="absolute z-10 w-full mt-2 bg-white dark:bg-dark rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 max-h-60 overflow-auto overflow-hidden">
                      ...
                      <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="w-full pl-10 pr-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-900 dark:focus:ring-white focus:border-gray-900 dark:focus:border-white text-gray-900 dark:text-white bg-white dark:bg-dark placeholder:text-gray-400 dark:placeholder:text-gray-500"
                            disabled={isLoading}
                          />
                        </div>
