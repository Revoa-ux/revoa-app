      ...
      <div className="bg-white dark:bg-dark rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div className="space-y-3 mt-6">
          <div className={`border rounded-lg overflow-hidden transition-all duration-200 ${
            option === 'existing'
              ? 'border-gray-900 dark:border-gray-600 bg-gray-50/50 dark:bg-dark/50'
        ...
        <div className="fixed inset-0 z-[9999] overflow-y-auto">
          ...
          <div className="relative min-h-screen flex items-center justify-center p-4">
            <div className="relative bg-white dark:bg-dark rounded-xl shadow-xl max-w-2xl w-full max-h-[85vh] flex flex-col">
                ...
                <div className="mt-4 flex items-center gap-3">
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2 bg-white dark:bg-dark border border-gray-300 dark:border-gray-600 rounded-lg text-sm text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-transparent"
                    />
                    {searchTerm && (
                      <button
                ...
                {isLoading ? (
                  <div className="space-y-2">
                    {Array.from({ length: 6 }).map((_, i) => (
                      <div key={i} className="w-full p-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-dark">
                        ...
                        <button
                          ...
                          className={`w-full text-left p-3 rounded-lg border transition-colors ${
                            isSelected
                              ...
                              : 'border-gray-200 dark:border-gray-700 bg-white dark:bg-dark hover:bg-gray-50 dark:hover:bg-gray-700'
                          }`}
                        >
                          <div className="flex items-start gap-3">
                            {firstImage?.url ? (
              ...
              <div className="px-6 py-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 flex-shrink-0 rounded-b-xl">
                <div className="flex items-center justify-between">
