...
export default function BottomSheet({ children, isOpen: controlledIsOpen, onOpenChange }: BottomSheetProps) {
  ...
  return (
    <>
      ...
      <div
        ref={sheetRef}
        className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 z-50 lg:hidden rounded-t-2xl shadow-2xl"
        style={{
