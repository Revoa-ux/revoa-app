      ...
      <div className="px-6 py-4 flex items-center justify-between">
        ...
        {onSubmit && (
          <button
            ...
            className="px-5 py-1.5 text-sm font-medium text-white bg-gray-900 dark:bg-gray-700 hover:bg-black dark:hover:bg-gray-600 rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
          >
            {isSubmitting ? (
              <>
