...
const variantStyles: Record<BannerVariant, {
  ...
  info: {
    ...
    gradientDark: 'linear-gradient(to bottom, rgba(30, 58, 138, 0.2), rgba(23, 23, 23, 0.5))',
  ...
  warning: {
    ...
    gradientDark: 'linear-gradient(to bottom, rgba(113, 63, 18, 0.2), rgba(23, 23, 23, 0.5))',
  ...
  error: {
    ...
    gradientDark: 'linear-gradient(to bottom, rgba(127, 29, 29, 0.2), rgba(23, 23, 23, 0.5))',
  ...
  success: {
    ...
    gradientDark: 'linear-gradient(to bottom, rgba(20, 83, 45, 0.2), rgba(23, 23, 23, 0.5))',
