      ...
      {effectiveCollapsed && (
        <div className="px-2 py-4 border-t border-gray-100/50 dark:border-gray-700/50 flex justify-center">
          <Link to="/admin/profile" onClick={() => setIsMobileMenuOpen(false)}>
            <div className="h-9 w-9 rounded-full bg-[linear-gradient(135deg,#E11D48_40%,#EC4899_80%,#E8795A_100%)] flex items-center justify-center text-white font-semibold text-sm hover:ring-2 ring-gray-200 dark:ring-gray-700 transition-all">
              {adminInitials}
            </div>
          </Link>
        </div>
