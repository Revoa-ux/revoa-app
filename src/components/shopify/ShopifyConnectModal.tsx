...
import { X, Store, Loader2 } from 'lucide-react'; // eslint-disable-line @typescript-eslint/no-unused-vars
...
const ShopifyConnectModal: React.FC<ShopifyConnectModalProps> = ({ 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const authUrl = await generateAuthUrl(validDomain);
            ...
            {step === 'input' ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-sm text-gray-600">
                  Please complete the authentication process in the new tab.
                </p>
              </div>
            )}
          </div>
