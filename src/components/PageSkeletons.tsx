  ...
  <div className="animate-pulse">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      {Array.from({ length: 9 }).map((_, i) => (
        <div key={i} className="h-[180px] p-4 rounded-xl bg-white dark:bg-dark border border-gray-200 dark:border-gray-700 flex flex-col">
  ...
  <div className="space-y-6 animate-pulse">
    ...
    <div className="grid grid-cols-4 gap-6">
      {Array.from({ length: 4 }).map((_, i) => (
        <div key={i} className="bg-white dark:bg-dark p-6 rounded-xl border border-gray-200 dark:border-gray-700">
...
export const ChatSkeleton = () => (
  <div className="space-y-6 animate-pulse">
    <div className="h-8 w-64 bg-gray-200 dark:bg-gray-700 rounded-lg"></div>
    <div className="bg-white dark:bg-dark rounded-xl border border-gray-200 dark:border-gray-700 h-[calc(100vh-7.6rem)]">
  ...
  <div className="space-y-6 animate-pulse">
    ...
    <div className="grid grid-cols-4 gap-6">
      {Array.from({ length: 8 }).map((_, i) => (
        <div key={i} className="bg-white dark:bg-dark rounded-xl border border-gray-200 dark:border-gray-700">
...
export const QuotesSkeleton = () => (
  <div className="space-y-6 animate-pulse">
    ...
    <div className="bg-white dark:bg-dark rounded-xl border border-gray-200 dark:border-gray-700">
      <div className="p-4 border-b border-gray-200 dark:border-gray-700 flex space-x-8">
        {Array.from({ length: 5 }).map((_, i) => (
          <div key={i} className="h-4 w-20 bg-gray-200 dark:bg-gray-700 rounded"></div>
        ))}
      </div>
      {Array.from({ length: 6 }).map((_, i) => (
        <div key={i} className="p-4 border-b border-gray-100 dark:border-gray-700 flex items-center space-x-8">
  ...
  <div className="space-y-6 animate-pulse">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      {Array.from({ length: 3 }).map((_, i) => (
        <div key={i} className="bg-white dark:bg-dark p-6 rounded-xl border border-gray-200 dark:border-gray-700">
          <div className="h-4 w-24 bg-gray-200 dark:bg-gray-700 rounded mb-4"></div>
          <div className="h-10 w-36 bg-gray-200 dark:bg-gray-700 rounded mb-2"></div>
          <div className="h-3 w-20 bg-gray-200 dark:bg-gray-700 rounded"></div>
        </div>
      ))}
    </div>
...
export const AutomationSkeleton = () => (
  <div className="space-y-6 animate-pulse">
    ...
    <div className="space-y-4">
      {Array.from({ length: 5 }).map((_, i) => (
        <div key={i} className="bg-white dark:bg-dark rounded-xl border border-gray-200 dark:border-gray-700 p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
...
export const AuditSkeleton = () => (
  <div className="space-y-6 animate-pulse">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      {Array.from({ length: 6 }).map((_, i) => (
        <div key={i} className="bg-white dark:bg-dark rounded-xl border border-gray-200 dark:border-gray-700 p-6">
