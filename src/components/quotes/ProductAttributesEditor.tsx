      ...
      {attributes.length > 0 && (
        <div className="space-y-2">
          {attributes.map((attr, index) => (
            <div
              key={index}
              className="flex items-center justify-between p-2 bg-white dark:bg-dark border border-gray-200 dark:border-gray-700 rounded-lg"
            >
      ...
      {!disabled && (
        <div className="flex items-center space-x-2">
          <input
            ...
            className="flex-1 px-3 py-1.5 bg-white dark:bg-dark border border-gray-300 dark:border-gray-600 rounded-lg text-xs text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          <input
            type="text"
            value={newAttrValue}
