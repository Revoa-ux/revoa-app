              ...
              <div className="space-y-6">
                ...
                <div className="flex space-x-3">
                  <button
                    ...
                    onClick={() => setStep('method_select')}
                    disabled={isSyncing}
                    className="flex-1 h-10 px-4 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors disabled:opacity-50"
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    disabled={isSyncing}
                    className="group flex-1 h-10 px-4 text-sm font-medium text-white bg-gradient-to-r from-green-600 to-emerald-600 rounded-lg hover:from-green-700 hover:to-emerald-700 hover:shadow-md transition-all disabled:opacity-50 flex items-center justify-center shadow-sm"
                  >
                    {isSyncing ? (
                      <>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex space-x-3">
                  <button
                    type="button"
                    onClick={onClose}
                    className="flex-1 h-10 px-4 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    className="group flex-1 h-10 px-4 text-sm font-medium text-white bg-gray-900 dark:bg-gray-700 rounded-lg hover:bg-gray-800 dark:hover:bg-gray-600 hover:shadow-md transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                  >
                    {isValidating ? (
                      <>
                        <Loader2 className="w-4 h-4 mr-2 animate-spin" />
              ...
              <div className="space-y-6">
                ...
                <div className="flex space-x-3">
                  ...
                  <button
                    ...
                    className="group flex-1 h-10 px-4 text-sm font-medium text-white bg-gray-900 dark:bg-gray-700 rounded-lg hover:bg-gray-800 dark:hover:bg-gray-600 hover:shadow-md transition-all flex items-center justify-center"
                  >
                    Try Again
                    <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-0.5 transition-transform" />
                  </button>
