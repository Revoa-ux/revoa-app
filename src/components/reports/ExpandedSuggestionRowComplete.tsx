...
export const ExpandedSuggestionRowComplete: React.FC<ExpandedSuggestionRowProps> = ({
  suggestion,
  onAccept,
  onDismiss,
  onClose
  ...
  return (
    ...
    >
      <div className="bg-white/95 dark:bg-[#1f1f1f]/95 backdrop-blur-xl border-x border-b border-gray-200/50 dark:border-[#3a3a3a]/50 rounded-b-xl shadow-lg">
        {/* Header */}
        ...
        <div className="px-6 py-5">
          <div className="space-y-5">
            ...
            <div className="bg-white/80 dark:bg-[#1f1f1f]/80 backdrop-blur-sm border border-gray-200/50 dark:border-[#3a3a3a]/50 rounded-xl p-5">
              <div className="flex items-center gap-2 mb-3">
                ...
                {suggestion.reasoning.dataPointsAnalyzed && (
                  <span className="text-xs px-2 py-0.5 bg-gray-100 dark:bg-[#1f1f1f] text-gray-600 dark:text-gray-400 rounded-full font-medium ml-auto">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        {geographic.topPerforming.slice(0, 4).map((geo, idx) => (
                          <div key={idx} className="bg-gray-50 dark:bg-[#1f1f1f]/50 rounded-lg p-3">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        {temporal.bestPerforming.map((time, idx) => (
                          <div key={idx} className="bg-gray-50 dark:bg-[#1f1f1f]/50 rounded-lg p-2 text-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white/80 dark:bg-[#1f1f1f]/80 backdrop-blur-sm border border-gray-200/50 dark:border-[#3a3a3a]/50 rounded-xl p-4">
                <div className="flex items-center gap-2 mb-2">
              ...
              <div className="bg-white/80 dark:bg-[#1f1f1f]/80 backdrop-blur-sm border border-gray-200/50 dark:border-[#3a3a3a]/50 rounded-xl p-5">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {suggestion.estimated_impact.expectedSavings !== undefined && (
                    <div className="bg-gray-50 dark:bg-[#1f1f1f]/50 rounded-lg p-3">
              ...
              {suggestion.reasoning.metrics && Object.keys(suggestion.reasoning.metrics).length > 0 && (
                <div className="grid grid-cols-3 gap-3">
                  {Object.entries(suggestion.reasoning.metrics).map(([key, value]) => (
                    <div key={key} className="bg-gray-50 dark:bg-[#1f1f1f]/50 border border-gray-200 dark:border-[#3a3a3a] rounded-lg p-3">
            ...
            {suggestion.recommended_rule && canAccept && (
              <div className="bg-white/80 dark:bg-[#1f1f1f]/80 backdrop-blur-sm border border-gray-200/50 dark:border-[#3a3a3a]/50 rounded-xl p-5">
                ...
                <div className="flex flex-wrap gap-2 text-xs text-gray-600 dark:text-gray-400 mb-4">
                  <div className="flex items-center gap-1.5 bg-gray-50 dark:bg-[#1f1f1f] px-2.5 py-1 rounded-lg">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {suggestion.reasoning.sampleDataPoints.slice(0, 3).map((sample: any, idx: number) => (
                        <div key={idx} className="bg-gray-50 dark:bg-[#1f1f1f]/50 rounded-lg p-2 text-xs font-mono">
        ...
        {/* Footer */}
        <div className="bg-gray-50 dark:bg-[#1f1f1f] border-t border-gray-200 dark:border-[#3a3a3a] px-6 py-4">
          {showDismissReason ? (
            <div className="flex items-center gap-3">
              <input
                ...
                className="flex-1 px-3 py-2 text-sm bg-white dark:bg-[#1f1f1f] border border-gray-300 dark:border-[#4a4a4a] rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 dark:focus:ring-red-500"
                autoFocus
              />
              <button
                onClick={() => {
