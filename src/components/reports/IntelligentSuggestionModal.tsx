...
export const IntelligentSuggestionModal: React.FC<IntelligentSuggestionModalProps> = ({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="relative bg-white dark:bg-dark rounded-2xl shadow-2xl w-full max-w-6xl max-h-[90vh] flex flex-col border border-gray-200 dark:border-gray-700">
          ...
          <div className="grid grid-cols-3 gap-6">
            <div className="col-span-2 space-y-6">
              ...
              {hasDeepData && (
                <div className="grid grid-cols-2 gap-4">
                  {supportingData.demographics && supportingData.demographics.length > 0 && (
                    <div className="bg-white dark:bg-dark border border-gray-200 dark:border-gray-700 rounded-xl p-4">
                      <div className="flex items-center gap-2 mb-3">
              ...
              {suggestion.estimated_impact && (
                <div className="bg-white dark:bg-dark border border-gray-200 dark:border-gray-700 rounded-xl p-5">
