        ...
        <div className="px-6 py-6 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-800">
          ...
          <div className={`rounded-xl border-2 p-4 ${getUrgencyBgColor()}`}>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className={`text-xs font-semibold px-2 py-1 rounded-full bg-white dark:bg-gray-800 ${getUrgencyColor()}`}>
        ...
        <div className="px-6 py-5 border-b border-gray-200 dark:border-gray-700">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white dark:from-gray-900/50 dark:to-gray-900/50 rounded-lg p-4 border border-gray-300 dark:border-gray-700 hover:shadow-lg transition-all duration-200">
              <div className="flex items-center gap-2 mb-3">
                <div className="p-1.5 bg-gray-200 dark:bg-gray-800 rounded">
              ...
              <div className="bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-900/30 dark:to-amber-900/20 rounded-xl p-5 border-2 border-orange-300 dark:border-orange-700 shadow-md">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-lg p-4 mb-4 border border-orange-200 dark:border-orange-800">
