    ...
    <div className="space-y-12">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-4">
          <button
            className="flex items-center justify-center space-x-2 h-[39px] px-3 text-sm text-gray-600 dark:text-gray-400 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
      ...
      <div className="grid grid-cols-4 gap-6">
        ...
        {[
          ...
          <div key={index} className="bg-white dark:bg-gray-900 p-6 rounded-xl border border-gray-200 dark:border-gray-700 h-[140px] flex flex-col justify-between">
      ...
      <div className="mt-16">
        ...
        <div className="grid grid-cols-4 gap-6">
          ...
          {[
            ...
            <div key={index} className="bg-white dark:bg-gray-900 p-6 rounded-xl border border-gray-200 dark:border-gray-700 h-[120px] flex flex-col justify-between">
              <h3 className="text-xs text-gray-500 dark:text-gray-400">{card.label}</h3>
