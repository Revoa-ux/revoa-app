  ...
  useEffect(() => {
    const handleCallback = async () => {
      try {
        ...
        // Handle the callback
        await handleShopifyCallback(code, shop, state);
        ...
        if (window.opener) {
          ...
          // Navigate to onboarding if not a popup
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 max-w-md w-full">
          <div className="text-center">
            ...
            <h2 className="text-xl font-medium text-gray-900 mb-2">Connection Failed</h2>
        ...
        {status === 'loading' ? (
          ...
          <div className="space-y-6">
            <div>
              ...
              <h2 className="text-xl font-medium text-gray-900 mb-2">Connection Successful</h2>
