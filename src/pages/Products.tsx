            ...
            <div className="flex-1 sm:flex-initial sm:w-[280px]">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-[38px] pl-10 pr-10 text-sm bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-300 dark:focus:ring-gray-600 focus:border-gray-200 dark:focus:border-gray-700 text-gray-900 dark:text-white"
                />
                {searchTerm && (
                  <button
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                {loading && !isBlocked ? (
                  ...
                  getFilteredAndSortedProducts.map((product) => (
                    <tr
                      key={product.id}
                      className="hover:bg-gray-50 dark:hover:bg-gray-700/50 bg-white dark:bg-gray-800"
                    >
                      <td className="px-4 py-4 text-sm sticky left-0 bg-white dark:bg-gray-800">
                        <div className="flex items-center space-x-3">
