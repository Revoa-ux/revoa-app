...
export default function DashboardCopy() {
  ...
  const CustomTooltip = ({ active, payload, label }: any) => {
    if (active && payload && payload.length) {
      return (
        <div className="bg-white dark:bg-dark p-4 border border-gray-200 dark:border-[#3a3a3a] rounded-lg shadow-md">
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center space-x-4">
          <button
            className="px-3 py-2 text-sm text-gray-600 dark:text-gray-400 bg-white dark:bg-dark border border-gray-200 dark:border-[#3a3a3a] rounded-lg hover:bg-gray-50 dark:hover:bg-[#3a3a3a] transition-colors flex items-center space-x-2"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {cardsData.map((card) => (
            <div 
              ...
              className="h-[180px] p-4 rounded-xl cursor-pointer transition-colors bg-white dark:bg-dark border border-gray-200 dark:border-[#3a3a3a] hover:bg-gray-50 dark:hover:bg-[#3a3a3a] flex flex-col"
            >
                ...
                <button
                  ...
                  className={`px-3 py-2 text-sm rounded-lg transition-colors ${
                    selectedCard === card.id
                      ? 'bg-dark dark:bg-[#3a3a3a] text-white'
