      ...
      >
        ...
        <div className="w-full max-w-[420px] space-y-8 relative">
          {state.status === 'verifying' && (
            <div className="bg-white dark:bg-dark shadow-sm rounded-2xl p-12 border border-gray-200 dark:border-gray-700">
          ...
          {state.status === 'error' && (
            <div className="bg-white dark:bg-dark shadow-sm rounded-2xl p-8 space-y-6 border border-gray-200 dark:border-gray-700">
