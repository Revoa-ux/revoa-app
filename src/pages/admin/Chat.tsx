    ...
    <div className="p-8">
      <div className="max-w-[1050px] mx-auto">
        ...
        <div className="flex flex-col h-[calc(100vh-14rem)] bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
          ...
          {/* Main Content: Conversations List + Chat Area */}
          <div className="flex flex-1 overflow-hidden">
          {/* Conversations List */}
          <div className={`border-r border-gray-200 dark:border-gray-700 flex flex-col overflow-hidden transition-all duration-300 ${
