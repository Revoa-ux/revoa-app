...
const AdminChat = () => {
  ...
  return (
    <>
        ...
        <div className="flex flex-col md:flex-row h-[calc(100vh-10rem)] sm:h-[calc(100vh-11rem)] lg:h-[calc(100vh-12rem)] bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
          {/* Conversations List */}
