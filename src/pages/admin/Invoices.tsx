...
interface AssignInvoiceModalProps {
  invoice: Invoice; // Required prop but not used in this component
  onClose: () => void;
  onAssign: (userId: string) => void;
}

const AssignInvoiceModal: React.FC<AssignInvoiceModalProps> = ({
  invoice, // Keeping the prop even though it's not used to maintain interface compatibility
  onClose,
  onAssign
}) => {
        ...
        <div className="divide-y divide-gray-200 dark:divide-gray-700">
          {filteredUsers.map((user) => (
            <button
              ...
              className="w-full px-4 py-3 flex items-start hover:bg-gray-50 dark:hover:bg-gray-700/50 dark:bg-gray-900/50 transition-colors"
            >
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
              <tr>
                <th className="w-[30%] px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-900/50 border-b border-gray-200 dark:border-gray-700 first:rounded-tl-xl">Invoice</th>
                <th className="w-[20%] px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-900/50 border-b border-gray-200 dark:border-gray-700">Date</th>
                <th className="w-[15%] px-6 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-900/50 border-b border-gray-200 dark:border-gray-700">Amount</th>
                <th className="w-[15%] px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-900/50 border-b border-gray-200 dark:border-gray-700">Status</th>
                <th className="w-[20%] px-6 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-900/50 border-b border-gray-200 dark:border-gray-700 last:rounded-tr-xl">Actions</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
              {filteredInvoices.map((invoice) => (
                <tr key={invoice.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 dark:bg-gray-900/50">
