    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-4 gap-6">
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700">
          ...
          <h3 className="text-xs text-gray-500 dark:text-gray-400">Total Admins</h3>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700">
          ...
          <p className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-1">1h 58m</p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700">
          ...
          <h3 className="text-xs text-gray-500 dark:text-gray-400">Avg Performance</h3>
          <p className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-1">91%</p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700">
          ...
          <h3 className="text-xs text-gray-500 dark:text-gray-400">Total Volume</h3>
          <p className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-1">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-8">
                  <div className="text-right">
                    <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{admin.assignedUsers}</p>
                    <p className="text-xs text-gray-500 dark:text-gray-400">Users</p>
                  </div>
                  <div className="text-right">
                    <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{admin.avgResponseTime}</p>
                    <p className="text-xs text-gray-500 dark:text-gray-400">Avg Response</p>
                  </div>
                  <div className="text-right">
                    <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{admin.performance.score}%</p>
      ...
      {showInviteModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="relative bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-md">
            <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">Invite Admin</h3>
                <button 
