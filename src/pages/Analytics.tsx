          ...
          {(() => {
            ...
            if (shopify.isConnected) {
              connectedPlatformsList.push({
                ...
                name: 'Shopify',
                icon: (
                  <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="#96BF48">
                    <path d="M15.337 23.979l7.216-1.561s-2.604-17.613-2.625-17.73c-.018-.116-.114-.192-.211-.192s-1.929-.136-1.929-.136-1.275-1.274-1.439-1.411c-.045-.037-.075-.057-.121-.074l-.914 21.104h.023zm-1.474-17.659c0-.076-.083-.126-.162-.126-.076 0-1.627.474-1.627.474s-1.126-3.115-3.263-3.115c-.095 0-.189.011-.283.027-.374-.469-.837-.674-1.24-.674-3.024 0-4.475 3.773-4.926 5.697-.716.222-1.219.378-1.221.378-.725.227-.747.249-.84.936-.076.531-1.962 15.081-1.962 15.081l14.655 2.529.869-21.207zm-5.894-1.413c0 .053 0 .105.005.158-.764.236-1.597.495-2.433.754.467-1.796 1.348-2.669 2.118-2.991.186.506.31 1.198.31 2.079zm-1.226-2.993c.139 0 .278.036.413.108-.998.467-2.074 1.643-2.525 4.001-.663.206-1.312.406-1.906.59.532-1.809 1.783-4.699 4.018-4.699zm.627 12.447s-.672-.357-1.499-.357c-1.212 0-1.272.761-1.272.953 0 1.045 2.727 1.446 2.727 3.891 0 1.925-1.221 3.163-2.866 3.163-1.976 0-2.985-1.229-2.985-1.229l.528-1.745s1.039.892 1.915.892c.572 0 .804-.451.804-.782 0-1.366-2.239-1.427-2.239-3.665 0-1.884 1.352-3.708 4.087-3.708 1.052 0 1.573.301 1.573.301l-.773 2.286z"/>
                  </svg>
                )
              });
            } else {
            ...
            return (
              <>
                ...
                {connectedPlatformsList.map((platform) => (
                  <div
                    key={platform.id}
                    className="flex items-center gap-1.5 px-2 py-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md h-[27px]"
                  >
                ...
                {unconnectedPlatformsList.length > 0 && (
                  <div className="relative" ref={addPlatformRef}>
                    <button
                      ...
                      className="flex items-center justify-center w-[27px] h-[27px] bg-white dark:bg-gray-800 border border-dashed border-gray-300 dark:border-gray-600 rounded-md hover:border-gray-400 dark:hover:border-gray-500 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all"
                      title="Add platform"
                    >
